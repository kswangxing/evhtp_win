...
foreach(_expectedTarget libevhtp::evhtp)
...
# Create imported target libevhtp::evhtp
add_library(libevhtp::evhtp SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/libevhtpTargets-*.cmake")
